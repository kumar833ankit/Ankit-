...
url = "https://weather.com/en-GB/weather/today/l/51.55,-0.38?par=google"

master = Tk()
master.title("Weather App")
master.config(bg = "white")

img = Image.open("D:/python/codezilla/weather.png")
...
def getWeather():
    ...
    location = soup.find('h1',class_="--components-src-organism-CurrentConditions-CurrentConditions--location--1YWj_").text
    temperature = soup.find('span',class_="--components-src-organism-CurrentConditions-CurrentConditions--tempValue--3KcTQ").text
    weatherPrediction = soup.find('div',class_="--components-src-organism-CurrentConditions-CurrentConditions--phraseValue--mZC_p").text
